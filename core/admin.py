...
make_refund_accepted.short_description = 'Update order data'


class OrderAdmin(admin.ModelAdmin):
    list_display = ['user', 'ordered', 'being_delivered',
                    'recieved', 'refund_requested', 'refund_granted', 'billing_address', 'shipping_address', 'payment',
                    'coupon']
...
class AddressAdmin(admin.ModelAdmin):
    ...
    search_fields = [
        'user', 'street_address', 'apartment_address', 'zip'
    ]
